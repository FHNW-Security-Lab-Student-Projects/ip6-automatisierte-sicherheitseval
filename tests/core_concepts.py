...
print(proj.filename) # should print the filename of the binary, e.g., "tests/protostar_stack0"
print(proj.loader) # should print the loader information, e.g., "ELF"
print(proj.loader.shared_objects) # should print the shared objects loaded by the binary
...
print(proj.loader.main_object.execstack) # should print whether the binary has an executable stack
print(proj.loader.main_object.pic) # should print whether the binary is position-independent
...
print(block.instruction_addrs) # should print the addresses of the instructions in the block
...
print(state.regs.rip) # should print the value of the instruction pointer register, e.g., 0x8048080
print(state.regs.rax) # should print the value of the rax register, e.g., 0x0
print(state.mem[proj.entry].int.resolved) # should print the value at the entry point address, e.g., 0x55

bv = claripy.BVV(0x1234, 32) 
print(bv) # should print the bitvector information, e.g., "0x1234"
print(state.solver.eval(bv)) # should print the evaluated value of the bitvector, e.g., 0x1234
...
print(simgr.active[0].regs.rip) # should print the value of the instruction pointer register of the active state
print(state.regs.rip) # should print the value of the instruction pointer register of the original state
