...
if simulation.found:
    print(simulation.found) # should print the found states that reached the successful condition, e.g., "SimState(0x8048080)"
    print(simulation.found[0]) # should print the first found state, e.g., "SimState(0x8048080)"
